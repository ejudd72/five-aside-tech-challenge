...
const About = ({ showAbout }) => (  
    ...
    <div class="container about"> 
        ...
        <p>This app was built by Ellie as part of the DevelopMe_ Coding Fellowship September-December 2019. You can find out a bit more about what DevelopMe does <a href="https://developme.training/" target="_blank" rel="noopener noreferrer">here</a> or visit my Github account <a href="https://github.com/ejudd72/" target="_blank" rel="noopener noreferrer">here </a></p>
    </div>
    )
)
